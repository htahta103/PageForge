...
type Repository interface {
	...
	UpdateProject(ctx context.Context, id uuid.UUID, name *string, theme *json.RawMessage) (*model.Project, error)
	...
	UpdatePage(ctx context.Context, projectID, pageID uuid.UUID, name, slug *string, components *json.RawMessage, order *int) (*model.Page, error)
