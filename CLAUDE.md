...
**YOU ARE IN: `pageforge/polecats/obsidian/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/pageforge/` (rig root) or other directories
...
**Your mail address:** `pageforge/polecats/obsidian`
**Your rig:** pageforge
**Your Witness:** `pageforge/witness`
...
| Ask Witness for help | `gt mail send pageforge/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`pageforge/witness`) when:
...
```bash
gt mail send pageforge/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
