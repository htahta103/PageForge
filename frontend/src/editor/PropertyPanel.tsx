  ...
  if (!comp) {
    return (
      <div className="space-y-2">
        ...
        <p className="text-sm text-fg-muted">{t('editor.properties.none')}</p>
      </div>
    )
  }
    ...
    <div className="space-y-4">
      ...
      {comp.type === 'text' && (
        <Field label={t('prop.text.body')}>
          <textarea
            className="min-h-[96px] w-full rounded-md border border-border bg-surface px-2 py-1 text-sm text-fg"
      ...
      {comp.type === 'custom-html' && (
        <>
          <Field label={t('prop.customHtml.html')}>
            <textarea
              className="min-h-[120px] w-full rounded-md border border-border bg-surface px-2 py-1 font-mono text-xs text-fg"
