...
dev-web: ## (Quarantined) Start legacy attic/web dev server
	@echo "attic/web/ is quarantined and not part of the supported pipeline. Canonical UI is frontend/."
	@echo "If you really meant attic/web/: cd attic/web && npm install && npm run dev"
